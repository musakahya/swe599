...
export default function App() {
  ...
  const handleStart = () => {
      setLoading(true);
      if (domain === "time_domain" || domain === "wavelet" || domain === "cosine") {
        axios
          .get("/" + domain + "/")
        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography
              ...
              paragraph
            >
              Embed secret images into your audio files to claim ownership.
              Compare embedding in different domains such as{" "}
              <strong>time, cosine,</strong> and <strong>wavelet</strong>. Pick
        ...
        <Container className={classes.cardGrid} maxWidth="md">
          ...
          <FormControl className={classes.formControl} fullWidth>
            ...
            >
              ...
              <MenuItem value={"time_domain"}>Time</MenuItem>
              <MenuItem value={"cosine"}>Discrete Cosine Transform</MenuItem>
              <MenuItem value={"wavelet"}>Discrete Wavelet Transform</MenuItem>
            </Select>
          </FormControl>
          <FormControl className={classes.formControl} fullWidth>
            <Button
              disabled={domain === "" || image === "" || audio === ""}
              variant="contained"
              color="primary"
              onClick={handleStart}
            >
          ...
          {isLoading === true || isLoading === false ? (
            <FormControl className={classes.formControl} fullWidth>
              {data && isAnalysisOpen ? (
                <Result isLoading={isLoading} data={data} domain={domain} />
              ) : (
                ""
              )}
            </FormControl>
